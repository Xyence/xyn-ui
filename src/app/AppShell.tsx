      ...
      <main className="layout">
          ...
          <div className="form-grid">
            ...
            <label>
              ...
              <input
                ...
                placeholder="arn:aws:iam::123:instance-profile/xyn"
              />
            </label>
            <label>
        ...
        <section className="card">
          <div className="card-header">
            ...
            <button className="ghost" onClick={handleDestroy} disabled={!selectedInstance || loading}>
              Destroy
            </button>
          </div>
          {!selectedInstance ? (
            ...
            <div className="detail-grid">
              <div>
                <p className="muted small">Instance ID</p>
                <strong>{selectedInstance.instance_id ?? "Not provisioned"}</strong>
              </div>
              <div>
                <p className="muted small">Region</p>
                <strong>{selectedInstance.aws_region}</strong>
              </div>
              <div>
                <p className="muted small">Public IP</p>
                <strong>{selectedInstance.public_ip ?? "Pending"}</strong>
              </div>
              <div>
        ...
        <section className="card">
          ...
          {!bootstrapLog && <p className="muted">Fetch the log to view output.</p>}
          {bootstrapLog && (
            <div className="log-panel">
              <pre>{bootstrapLog.stdout || "No stdout yet."}</pre>
              {bootstrapLog.stderr && <pre className="stderr">{bootstrapLog.stderr}</pre>}
            </div>
          )}
        </section>
      </main>
